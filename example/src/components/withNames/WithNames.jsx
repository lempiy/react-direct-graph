...
const exampleWithNamesCode = require("!!raw-loader!./ExampleWithNames.jsx");
...
export class WithNames extends Component {
    exampleComponent() {
        return <ExampleWithNames cellSize={cellSize} padding={padding} />;
    }
    ...
    render() {
        return (
            <Example
                code={exampleWithNamesCode.default}
