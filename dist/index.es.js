    ...
    DefaultNodeIcon.prototype.render = function () {
        ...
        return (createElement("svg", { version: "1.1", x: "0px", y: "0px", viewBox: "0 0 52 52" },
            createElement("g", null,
                ...
                createElement("g", { fill: "#ffffff", stroke: "#ffffff" },
                    createElement("text", { strokeWidth: "1", x: "0", y: "0", dx: "26", dy: "30", textAnchor: "middle", fontSize: "14px" }, node.id)))));
    };
...
var GraphElement = /** @class */ (function (_super) {
    ...
    GraphElement.prototype.renderNode = function () {
        ...
        return (!node.isAnchor && (createElement("g", __assign({ className: "node-icon-group" }, {
            onClick: onNodeClick &&
    ...
    GraphElement.prototype.renderLines = function () {
        ...
        return (lines.map(function (l) { return (createElement("line", __assign({}, {
            onClick: onEdgeClick &&
